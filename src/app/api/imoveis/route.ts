...
export async function POST(request: Request) {
  ...
  try {
    ...
    const imovelData = {
      ...
      comodidades_condominio: body.comodidades_condominio || [],
      // Financeiro
      valor: body.valor,
      valor_locacao: body.valor_locacao || null,
      ...
      seguro_incendio_mensal: body.seguro_incendio_mensal || null,
      taxa_administracao_pct: body.taxa_administracao_pct || null,
      ...
      tour_360_url: body.tour_360_url || null,
      // Status
